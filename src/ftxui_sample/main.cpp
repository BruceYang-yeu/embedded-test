...
// configuration step. It creates a namespace called `embedded_test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", embedded_test::cmake::project_name, embedded_test::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", embedded_test::cmake::project_version);
      return EXIT_SUCCESS;
    }
